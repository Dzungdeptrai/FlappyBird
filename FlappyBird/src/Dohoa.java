...
public class Dohoa {
	...
	public void triangulo(double x1, double y1, double x2, double y2, double x3, double y3, Cor cor) {
		triangulo((int) Math.round(x1), (int) Math.round(y1), (int) Math.round(x2), (int) Math.round(y2),
				(int) Math.round(x3), (int) Math.round(y3), cor);
	}
...
//		circulo((int) Math.round(cx), (int) Math.round(cy), raio, cor);
//	}
//
...
//		retangulo((int) Math.round(x), (int) Math.round(y), largura, altura, cor);
//	}
	...
	public void imagem(String arquivo, int xa, int ya, int larg, int alt, double dir, double x, double y) {
		...
		g.drawImage(sprites.get(arquivo), (int) Math.round(x), (int) Math.round(y), (int) Math.round(x) + larg,
