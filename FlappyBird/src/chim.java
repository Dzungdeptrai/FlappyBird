public class chim {
	...
	public void drawItself(Dohoa t) {
		t.imagem("flappy.png", sprites_x[sprite_states[sprite_state]], sprites_y[sprite_states[sprite_state]], 34, 24,
				Math.atan(vy / 200), x, y);
	}
