public class ScoreNumber {
	...
	public static int[][] numberData = { { 576, 200 }, { 578, 236 }, { 578, 268 }, { 578, 300 }, { 574, 346 },
	...
	public void drawScore(Dohoa t, int x, int y) {
		for (int i = 0; i < snumber.length(); i++) {
			drawNumber(t, Integer.parseInt(snumber.substring(i, i + 1)), x + 15 * i, y);
		}
	}

	public void drawRecord(Dohoa t, int x, int y) {
	...
	public void drawNumber(Dohoa t, int number, int x, int y) {
